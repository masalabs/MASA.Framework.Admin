...
public class CommandHandler
{
    ...
    public async Task AddAsync(RoleCommand.AddCommand command)
    {
        ...
        var role = new Role(command.Creator, command.Request.Name, command.Request.Number);
    ...
    public async Task EditAsync(RoleCommand.EditCommand command)
    {
        ...
        role.Update(command.Creator, command.Request.Name, command.Request.Describe);
