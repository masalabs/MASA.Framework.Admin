...
namespace MASA.Framework.Admin.Management.Pages.Home
{
    public partial class SimpleExample : ProCompontentBase
    {
        ...
        private List<DataTableHeader<DicViewModel>> _headers {
            ...
            get 
            {
                ...
                {
                    new ()
                    { Text = T("Others"), Value = nameof(DicViewModel.Name), Sortable = false },
                    new ()
