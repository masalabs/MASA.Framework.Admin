...
public partial class UserView
{
    ...
    private List<DataTableHeader<LoginRecord>> _loginRecordHeaders = new List<DataTableHeader<LoginRecord>>
    {
        ...
        new (){ Text= "IP 地址", Sortable= false, Value= nameof(LoginRecord.IP),Align= DataTableHeaderAlign.Center},
        new (){ Text= "是否成功", Sortable= false, Value= nameof(LoginRecord.Success),Align=DataTableHeaderAlign.Center},
        new (){ Text= "浏览器", Sortable= false, Value= nameof(LoginRecord.Browser),Align=DataTableHeaderAlign.Center},
        new (){ Text= "地理位置", Sortable= false, Value= nameof(LoginRecord.Address),Align=DataTableHeaderAlign.Center}
    };
